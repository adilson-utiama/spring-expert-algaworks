...
public class CidadesController {
	...
	@PostMapping("/nova")
	//@CacheEvict(value = "cidades", allEntries = true)//invalida todo o cache relacionado
	@CacheEvict(value = "cidades", key = "#cidade.estado.codigo", condition = "#cidade.temEstado()")//invalidação seletiva de cache
