...
public class VendasController {
	...
	public ModelAndView enviarEmail(Venda venda, BindingResult result, RedirectAttributes attributes, 
		...
		attributes.addFlashAttribute("mensagem",String.format("Venda nº %d salva com sucesso e enviado por email!", venda.getCodigo()));
		return new ModelAndView("redirect:/vendas/nova");
	}
	...
	public ModelAndView adicionarItem(Long codigoCerveja, String uuid){
		...
		tabelaItens.adicionar(uuid, cerveja, 1);
	...
	public ModelAndView editar(@PathVariable Long codigo){
		...
		for(ItemVenda item : venda.getItens()){
			tabelaItens.adicionar(venda.getUuid(), item.getCerveja(), item.getQuantidade());
		}
