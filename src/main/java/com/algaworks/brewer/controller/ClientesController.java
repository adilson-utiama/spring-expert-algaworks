...
public class ClientesController {
	...
	@Autowired
	private CadastroClienteService cadastroClienteSesrvice;
	...
	public ModelAndView salvar(@Valid Cliente cliente, BindingResult result, RedirectAttributes attributes){
		...
		try {
			cadastroClienteSesrvice.salvar(cliente);
	...
	public ModelAndView pesquisar(ClienteFilter clienteFilter, BindingResult result, 
		...
		PageWrapper<Cliente> paginaWrapper = new PageWrapper<Cliente>(clientes.filtrar(clienteFilter, pageable), httpServletRequest);
	...
	public @ResponseBody ResponseEntity<?> excluir(@PathVariable("codigo") Cliente cliente){
		...
		try{
			cadastroClienteSesrvice.excluir(cliente);
